...
type Repository interface {
	...
	GetOrdersByCustomerId(ctx context.Context, userId string) ([]model.Order, error)
	...
	GetOrderDetailsByProductId(ctx context.Context, productId string) ([]model.OrderDetails, error)
	GetOrderDetailsByOrderId(ctx context.Context, orderId string) ([]model.OrderDetails, error)
